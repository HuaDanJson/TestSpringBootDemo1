...
import okhttp.custom.android.retrofitutils.BuildConfig;
import okhttp.custom.android.retrofitutils.bean.CCApplication;
...
//    http://localhost:8081/jason/user/getAllUser

    private static final ApiEndpointClient INSTANCE = new ApiEndpointClient();
    private ApiEndpointServiceV2 mEndpointV2;

    private static final String PRODUCTION_APIV2 = "http://192.168.200.96:8081/jason/";
    private static final String SANDBOX_APIV2 = "http://192.168.200.96:8081/jason/";
    ...
    private ApiEndpointClient() {
        ...
        String hostv2 = BuildConfig.DEBUG_MODE ? SANDBOX_APIV2 : PRODUCTION_APIV2;
        ...
        mEndpointV2 = retrofitv2.create(ApiEndpointServiceV2.class);
    }
    ...
    public static ApiEndpointServiceV2 getEndpointV2() {
    ...
    private static class AppInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            String userAgent = DeviceUtil.toHumanReadableAscii("Android v" + BuildConfig.VERSION_NAME + "/" + Build.MODEL);
...
//            try {
//                HttpResponse httpResponse = GsonConverter.fromJson(json, HttpResponse.class);
//                if (httpResponse.getCode() == AppConstant.HttpResponseCode.INVALID_TOKEN && hasLogin()) {
//                    hasLogin(false);
//                    ActivityUtil.runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            Activity currentActivity = CCApplication.getInstance().getCurrentActivity();
////                            if (currentActivity != null) {
////                                LoggedOtherDeviceDialog loggedOtherDeviceDialog = new LoggedOtherDeviceDialog(currentActivity);
////                                loggedOtherDeviceDialog.show();
////                            }
//                        }
//                    });
//                }
